        ...
        <header className="sticky top-0 z-40 flex h-16 items-center justify-between border-b border-slate-200 bg-white/95 px-4 backdrop-blur-md md:px-8">
          ...
          <Link href="/" className="flex items-center gap-2.5 md:hidden">
            ...
            <div className="flex flex-col">
              <span className="font-bold text-slate-900 text-sm leading-tight">Memória Reflexiva</span>
          ...
          <div className="hidden md:flex items-center gap-2 text-xs text-slate-500 font-medium">
            ...
            <span>&ldquo;Mais do que um aplicativo, uma extensão da sua história.&rdquo;</span>
          </div>
          ...
          <div className="flex items-center gap-3">
            <Link
              href="/biblioteca"
              className="flex h-9 w-9 items-center justify-center rounded-full text-slate-600 hover:bg-slate-100 hover:text-blue-600 transition-colors"
